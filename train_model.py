...
flags.DEFINE_string('data_dir', './tensorflow_temp/data', 'Directory for storing data')
flags.DEFINE_string('summaries_dir', './tensorflow_temp/ges_rec_logs', 'Summaries directory')
...
def train():  
	...
	save_path = saver.save(sess,"./tensorflow_temp/conv_model_w.ckpt")
